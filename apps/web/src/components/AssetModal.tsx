        ...
        <form onSubmit={handleSubmit} className='p-6 space-y-4'>
          ...
          <div className='flex items-center justify-end gap-3 pt-4 border-t border-slate-800'>
            ...
            <button
              ...
              className='px-4 py-2 text-xs font-medium text-white bg-sky-600 hover:bg-sky-500 disabled:opacity-50 rounded-lg shadow-lg shadow-sky-600/20 transition-all'
            >
              {isSubmitting
                ? 'Guardando...'
                : assetToEdit
